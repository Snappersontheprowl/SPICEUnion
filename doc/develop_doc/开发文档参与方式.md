...
这类必须先进入根 [TODO](/my_lab/projects/SPICEUnion/TODO:1)，写清楚分步骤方案。
...
**1. 开发前：从路线图认领任务**
第一步看 [03_开发路线图.md](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/03_开发路线图.md:1)。
...
比如现在路线图里已经有 [统一用户工作流 API](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/03_开发路线图.md:25)，它定义了目标：
...
**2. 开发前：根 TODO 写实施计划**
如果是大改，下一步写根 [TODO](/my_lab/projects/SPICEUnion/TODO:1)。
...
**3. 开发前：必要时写专题草案**
如果功能有明显设计不确定性，就在 [20_专题记录](/my_lab/projects/SPICEUnion/doc/develop_doc/20_专题记录/README.md:1) 新增草案。
...
这些要等代码落地后才写进 [01_当前事实状态.md](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/01_当前事实状态.md:1)。
...
**6. 开发后：事实进入当前事实状态**
功能完成、测试通过后，更新 [01_当前事实状态.md](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/01_当前事实状态.md:1)。
...
**7. 开发后：架构变化进入架构总览**
如果功能改变架构，就更新 [02_架构总览.md](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/02_架构总览.md:1)。
...
**8. 开发后：README 主入口更新**
如果功能影响用户入口，就更新根 [README.md](/my_lab/projects/SPICEUnion/README.md:1)。
...
**9. 开发后：路线图从“计划”变成“状态”**
更新 [03_开发路线图.md](/my_lab/projects/SPICEUnion/doc/develop_doc/00_项目总览/03_开发路线图.md:1)。
...
**11. 开发后：根 TODO 清理**
根 [TODO](/my_lab/projects/SPICEUnion/TODO:1) 里活跃项要删除。
