...
| M6 | 开发文档侧已完成 | Python workflow binding，计划绑定 M5 workflow facade；责任文档为 `../10_阶段记录/06_M6_Python工作流Binding.md` |
| M7 | 暂缓 | 性能基准与发布形态 |
...
1. M6 Python workflow binding：根据真实 Python 调用需求绑定 `Simulation` /
   `SimulationResult`。
